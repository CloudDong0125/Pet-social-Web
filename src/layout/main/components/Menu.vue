<template>
    <el-menu
        ...
        :router="false"
    >
        <!-- Bug fix: 将 v-if 移动到父元素上 -->
        <template v-if="dataContainer.dataList.length > 0">
            <MenuItem
...
.menu-container {
    ...
    /** 基础目录配置 */
    --local-active-text-color: #409EFF;
    --local-active-bg-color: rgb(236, 245, 255);
